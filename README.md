...
| 知识库 | 检索能力 | 质量控制 |
|:---:|:---:|:---:|
| 持续增长 (2020–2026) | **24** 组关键词 (宽/窄/中文) | **3** 道反幻觉防线 |
| **60+** 顶刊白名单 + 239 IF 库 | **18** 字段结构化笔记 | ~11,300 lines Python |
...
| 输出什么信什么 | **反幻觉 Pipeline**：Prompt 纪律 → 二次 API 自检 → `review_queue.json` 人工复核 | LLM 会编造——LitCall 有纠错机制 |
